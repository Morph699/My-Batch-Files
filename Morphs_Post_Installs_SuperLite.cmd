...
TITLE Morphs SuperLite installs
mode con:cols=78 lines=26
color 0E
RMDIR /S /Q "%WINDIR%\Setup\Files"
RMDIR /S /Q "%WINDIR%\Setup\Scripts"
start /min MorphsTweaks2025.cmd
mode con:cols=78 lines=26
cls
color 1F
cls
...
start OldNewExplorer.exe
echo [Done]
ping localhost -n 2 >nul
echo.
echo Installing The Latest Visual C++ 2015 - 202x x86-x64 Runtimes, please wait...
start /wait VisualCppRedist_AIO_x86_x64.exe /ai /gm2
echo [Done]
ping localhost -n 2 >nul
echo.
echo Installing Desktop Restore, please wait...
start /wait Desktop_Restore.msi /quiet /norestart
echo [Done]
ping localhost -n 2 >nul
color 1F
cls
...
echo.
echo ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
echo Installing Shortcut Manager, please wait...
start /wait Shortcut_Manager.msi /quiet /norestart
echo [Done]
ping localhost -n 2 >nul
echo.
echo Installing The Latest StartBack, please wait...
start startback_aio.exe /VERYSILENT /SUPPRESSMSGBOXES /NORESTART /SP-
echo [Done]
ping localhost -n 2 >nul
echo.
echo Installing The Latest WinRaR, please wait...
start /wait winrarx64.exe /S
start SlimBrowserPortable.exe
echo [Done]
ping localhost -n 2 >nul
color 1F
cls
...
echo 		    Loading Theme items, please wait...
echo.
start C:\Windows\system32\SystemPropertiesPerformance.exe
start /wait OldNewExplorerCfg.lnk
cls
mode con:cols=78 lines=26
color 0E
