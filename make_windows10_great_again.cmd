...
CD /d "%~dp0"
color 0E
:: Available from: https://gist.github.com/IntergalacticApps
echo   Making Windows 10 Great Again^^! Ultimate batch spyware and trash remover, v. 2.2.4.
...
echo.
echo spyware firewall rules, OneDrive, Windows default apps, spyware/bloatware services,   unsafe services, block spyware domains, Disable telemetry, Disable Cortana, Disable Windows Defender, Disable Windows Store, Disable Program Compatibility Assistant etc.
echo.
echo   By continuing you acknowledge that you will not be able to reverse these steps without a full reinstall of windows.
echo.
pause
cls
color 1F
