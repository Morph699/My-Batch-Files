...
chcp 65001 >nul
CD /d "%~dp0"
TITLE Morphs Windows and Portable Apps Installer Menu
...
echo.
echo  *** No programs or apps have been installed, please select one of the options below *** 
echo.
...
echo.
echo  5. Full Install 25+ GB Programs + pApps + Office 2024 (At least 80 GB space needed)
echo.
...
:Morph2024
start %WINDIR%\Setup\FilesU\Apocalypse\Apocalypse_Install.cmd
start %WINDIR%\Setup\FilesU\Post_Installs_morphs_ultimate.cmd
GOTO Quit

:Slim
start %WINDIR%\Setup\FilesU\Apocalypse\Apocalypse_Install.cmd
start %WINDIR%\Setup\FilesU\Post_Installs_Slim.cmd
GOTO Quit

:Simp
start %WINDIR%\Setup\FilesU\Apocalypse\Apocalypse_Install.cmd
start %WINDIR%\Setup\FilesU\Post_Installs_Simple.cmd
GOTO Quit

:Med
start %WINDIR%\Setup\FilesU\Apocalypse\Apocalypse_Install.cmd
start %WINDIR%\Setup\FilesU\Post_Installs_Min.cmd
GOTO Quit

:Full24
start %WINDIR%\Setup\FilesU\Apocalypse\Apocalypse_Install.cmd
start %WINDIR%\Setup\FilesU\Post_Installs_Full_2024.cmd
GOTO Quit

:Defen1
start %WINDIR%\Setup\FilesU\Defenderctrl\dControl.exe
GOTO Menu

:Defen2
start %WINDIR%\Setup\FilesU\Defenderctrl\Morphs_Disable_Defender.cmd
GOTO Menu

:DFirewall 
start %WINDIR%\Setup\FilesU\Defenderctrl\Morphs_Firewall_Disable.cmd
GOTO Menu

:EFirewall
start %WINDIR%\Setup\FilesU\Defenderctrl\Morphs_Firewall_Enable.cmd
GOTO Menu

:DismR
start %WINDIR%\Setup\FilesU\Wub\Morphs_Dism_Repair.cmd
GOTO Menu

:WinSXS
start %WINDIR%\Setup\FilesU\Wub\Morphs_Cleaning_WinSXS.cmd
GOTO Menu

:PauseUpdates
start %WINDIR%\Setup\FilesU\Wub\Morphs_Pause_Update_12-30-3000.cmd
GOTO MENU

:Wub
start %WINDIR%\Setup\FilesU\Wub\Wub_x64.exe
GOTO MENU
