...
echo.
echo ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
echo This will clean your Optimiser data folder (c:\ProgramData\Optimizer) ONLY!
echo Sometimes once its run it won't run due to the data folders or files remaining
echo.
timeout 3
if exist "c:\ProgramData\Optimizer" (

echo Clearing data folder 
RD /S /Q c:\ProgramData\Optimizer

) ELSE (echo No files to delete)

) ELSE (
echo.
echo Exiting momentarily
timeout 2
exit
