...
:Show
powershell -Command "Get-Disk -SerialNumber '0000_0001_2109_0668_3A5A_2703_D000_25AF*' | Get-Partition | Where-Object { $_.Type -eq 'Basic' } | Add-PartitionAccessPath -AccessPath 'H:\'"
GOTO MENU

:Hide
(echo select volume H & echo remove letter=H) | diskpart
GOTO Quit
