...
TITLE Morphs_Post_Installs_choice
chcp 65001 >nul
cd /d "%~dp0"

:: Tweak: Window height expanded to line 30 to cleanly contain all storage descriptors
...
echo                   [Notice: Windows\setup\filesU and
echo                    Windows\setup\filesU\Portables will be removed]
echo.
echo                2. Install only portables
echo                   [Notice: Only files inside windows\setup\filesU\Portables 
echo			  will be removed]
echo.
echo                3. Install only apps
echo                   [Notice: only files in Windows\setup\filesU will be removed 
echo			  No portables will be deleted to retain for future installs]
echo.
echo                9. Reboot
echo.
...
:Normal
start "" "%~dp0Morphs_Post_Installs_Max.cmd"
GOTO Quit
...
color 0E
echo ================================================================================
echo                    INITIALIZING SECURITY UTILITIES OVERLAY
echo ================================================================================
echo  Verifying anti-malware management hooks before launching portable extractors...
echo.
...
start "" "%~dp0Portables\PortableApps_1.cmd"
start "" "%~dp0Portables\PortableApps_2.cmd"
...
echo.
echo ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
echo                        PORTABLES EXTRACTED SUCCESSFULLY
echo ================================================================================
echo  Note: Upon final setup execution loop closure, only the files inside:
echo  '%WINDIR%\Setup\FilesU\Portables\' will be removed from your disk.
echo ================================================================================
echo.
GOTO Quit

:Apps
start "" "%~dp0Morphs_Post_Installs_Max_Plain.cmd"
GOTO Quit
:Quit
cls
color 0E
