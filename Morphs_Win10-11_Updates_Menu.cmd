...
chcp 65001 >nul
CD /d "%~dp0"
TITLE Morphs Win10 22H2 and Win11 22-23H2 Updates Menu
color 0E
...
echo              5. Start Windows updates For Win10 22H2 (Up to Aug 2024)
echo              7. Start Windows updates For Win11 22H2-23H2 (Up to Aug 2024)
echo              8. Start Windows updates For Win11 24H2 (Up to Aug 2024)
echo.
...
IF /I '%INPUT%'=='5' GOTO 22h2
IF /I '%INPUT%'=='7' GOTO 23h2
IF /I '%INPUT%'=='8' GOTO 24h2
