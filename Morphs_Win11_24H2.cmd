...
echo.
echo ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
echo 			if you get 'error 161', make sure have done a clean shut down 
echo 			using start then shut down not shut down using vm's options.
echo.
Dism /capture-image /imagefile:F:\Temp\install.esd /capturedir:M:\ /name:"Morphs_Win11_24H2" /Description:"Morphs Creations" /compress:maximum
echo. 
echo Done
