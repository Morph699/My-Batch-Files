...
start /wait AdobeAIR_51.2.2.6.exe -silent
ping localhost -n 2 >nul
echo.
...
start /wait windowsdesktop-runtime-10.0.1-win-x64.exe /quiet /norestart
start /wait windowsdesktop-runtime-10.0.1-win-x86.exe /quiet /norestart
echo [Done]
ping localhost -n 2 >nul
echo.
...
start /wait K-Lite_Codec_Pack_1935_Mega.exe /VERYSILENT /NORESTART /NOFILEASSOCIATIONS
...
ping localhost -n 1 >nul
echo.
rem echo Installing The Latest Dropbox, please wait...
rem start /wait "Dropbox 238.4.6075 Offline Installer.x64.exe" /NOLAUNCH
rem echo [Done]
