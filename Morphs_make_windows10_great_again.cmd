...
:: The original is available from https://gist.github.com/IntergalacticApps

cls
echo           "                    __                     __   __  __   __ ";
echo           "|\/| _  _ _ |_  _  /   _ _ _ |_. _  _  _    _) /  \  _) |_  ";
echo           "|  |(_)| |_)| )_)  \__| (-(_||_|(_)| )_)   /__ \__/ /__ __) ";
echo           "         |                                                  ";
echo   Making Windows Great Again^^! Morphs Ultimate batch spyware and trash remover

echo  ** This will remove or disable a lot of services and spyware/ apps **
echo.
echo Here are a few of the things that are disabled or removed:
echo Add spyware firewall rules, remove spyware/ bloatware services, 
echo remove unsafe services, block spyware domains, Disable telemetry, 
echo Disable Cortana, Disable Program Compatibility Assistant etc.
echo.
echo By continuing you acknowlegde that you will not be able to reverse these steps without a full reinstall of windows.
pause
color 1F
cls
...
if not exist %update_orchestrator_dir%\Reboot\ (
	echo.
	echo | set /p=Prevent Windows rebooting after installing updates... 
