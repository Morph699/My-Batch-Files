...
chcp 65001 >nul
CD /d "%~dp0"
TITLE Morphs Dism VM Scanner ESD
...
echo.
Dism /capture-image /imagefile:F:\Temp\install.esd /capturedir:M:\ /name:"Win10_22H2_Scanner" /Description:"Morphs Creations" /compress:maximum
echo. 
echo Done
