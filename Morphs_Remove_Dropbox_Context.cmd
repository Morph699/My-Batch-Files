...
chcp 65001 >nul
CD /d "%~dp0"
TITLE Morphs Dropbox_Context menu remover
...
echo.
echo ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
echo Please right click and exit the Dropbox system try icon first. 
echo It will also be force closed automatically...
echo.
echo Please keep in mind when you reopen the app the context menu will be back...
echo.
timeout 5
color 1F
cls
...
echo.
echo ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
echo Finding and removing context menu options, if still in the registry.
echo.
Reg.exe delete "HKCR\*\shellex\ContextMenuHandlers\DropboxExt" /f
Reg.exe delete "HKCR\Directory\Background\shellex\ContextMenuHandlers\DropboxExt" /f
Reg.exe delete "HKCR\Directory\shellex\ContextMenuHandlers\DropboxExt" /f
Reg.exe delete "HKCR\lnkfile\shellex\ContextMenuHandlers\DropboxExt" /f
