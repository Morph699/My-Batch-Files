...
Reg.exe add "HKCU\SOFTWARE\StartIsBack" /v "Start_AutoCascade" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKCU\SOFTWARE\StartIsBack" /v "Start_MinMFU" /t REG_DWORD /d "5" /f
...
Reg.exe add "HKCU\SOFTWARE\StartIsBack\Cache" /v "IdealHeight.6" /t REG_DWORD /d "1" /f
...
Reg.exe add "HKCU\SOFTWARE\StartIsBack\ShutdownChoices" /ve /t REG_DWORD /d "2" /f
