...
chcp 65001 >nul
CD /d "%~dp0"
TITLE Morphs Dism VM Installs ESD
...
echo.
echo ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
echo if you get 'error 161', make sure have done a clean shut down using start 
echo then shut down not shut down using vm's options.
echo.
Dism /capture-image /imagefile:F:\Temp\install.esd /capturedir:M:\ /name:"Win10_22H2_VM_Installs" /Description:"Morphs Creations" /compress:maximum
echo. 
echo Done
