@echo off
TITLE Morphs Win10 Maxed installs + Office2024
chcp 65001 >nul
...
:: FIXED: Changed 'call' to asynchronous 'start' execution to prevent deployment stall
...
:: FIXED: Normalized string formatting inside PowerShell strings to preserve clean formatting
...
:: Launch Portable Apps background configuration routines
:: FIXED: Standardized quotation marks to protect paths that contain spaces
if exist "%windir%\Setup\filesU\Portables\PortableApps_1.cmd" start "" /d "%windir%\Setup\filesU\Portables" "PortableApps_1.cmd"
timeout /t 2 >nul
if exist "%windir%\Setup\filesU\Portables\PortableApps_2.cmd" start "" /d "%windir%\Setup\filesU\Portables" "PortableApps_2.cmd"
...
shutdown /r /t 5 /c "Morphs Maxed Installer finalizing setup. Rebooting in 5 seconds..."
