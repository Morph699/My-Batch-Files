@echo off
TITLE Morphs_Post_Installs_Max
chcp 65001 >nul
cd /d "%~dp0"
...
:: Normalized string formatting inside PowerShell strings to preserve clean formatting
powershell -ExecutionPolicy Bypass -Command "write-host -fore Green -Back Black '********************** Welcome to Morphs Custom installer **********************'; Write-Host ''; write-host -fore Yellow -Back Black '********************* There are approx 500 Apps to be extracted ****************'; Write-Host ''; write-host -fore Green -Back Black '************** Setup will continue and restart your computer once done *********'; Write-Host ''; write-host -fore Yellow -Back Black '******************** Please sit back and enjoy the show ************************'"
timeout /t 2 >nul

if exist "%~dp0\Portables\PortableApps_1.cmd" start "" "%~dp0\Portables\PortableApps_1.cmd"
timeout /t 2 >nul
if exist "%~dp0\Portables\PortableApps_2.cmd" start "" "%~dp0\Portables\PortableApps_2.cmd"
...
if exist "%~dp0Kaleidoscope Grid_Maxed_Coloured.hta" (
    start "" "mshta.exe" "%~dp0Kaleidoscope Grid_Maxed_Coloured.hta"
)
...
:: Clear screen to display automated deletion notice clearly over the desktop context
cls
color 0E
echo ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
echo.
...
echo.
echo ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
echo                              AUTOMATED PURGE ALERT
echo ================================================================================
echo  Both setup deployment folders are about to be automatically removed from disk.
echo.
...
if "!SimulationMode!"=="0" (
    ...
    if exist "%WINDIR%\Setup\FilesU\Portables\" RMDIR /S /Q "%WINDIR%\Setup\FilesU\Portables\" 2>nul
