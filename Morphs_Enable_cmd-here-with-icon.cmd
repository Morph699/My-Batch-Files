...
echo.   
Reg.exe add "HKCR\Directory\shell\cmdprompt" /ve /t REG_SZ /d "@shell32.dll,-8506" /f
Reg.exe add "HKCR\Directory\shell\cmdprompt" /v "NoWorkingDirectory" /t REG_SZ /d "" /f
Reg.exe add "HKCR\Directory\shell\cmdprompt" /v "Icon" /t REG_EXPAND_SZ /d "%%systemroot%%\system32\cmd.exe,0" /f
cls
...
Reg.exe add "HKCR\Directory\Background\shell\cmdprompt" /ve /t REG_SZ /d "@shell32.dll,-8506" /f
Reg.exe add "HKCR\Directory\Background\shell\cmdprompt" /v "NoWorkingDirectory" /t REG_SZ /d "" /f
cls
...
Reg.exe add "HKCR\Drive\shell\cmdprompt" /ve /t REG_SZ /d "@shell32.dll,-8506" /f
Reg.exe add "HKCR\Drive\shell\cmdprompt" /v "NoWorkingDirectory" /t REG_SZ /d "" /f
cls
...
echo Please wait whilst loading configs...
echo. 
Reg.exe add "HKCR\Drive\shell\cmdprompt" /v "Icon" /t REG_EXPAND_SZ /d "%%systemroot%%\system32\cmd.exe,0" /f
