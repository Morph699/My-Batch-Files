@echo off
TITLE Morphs_Post_Installs_X-SuperLite 
chcp 65001 >nul
cd /d "%~dp0"
...
if exist "%~dp0MorphsSplash.hta" (
    start "" "mshta.exe" "%~dp0MorphsSplash.hta"
)
...
for /f "delims=" %%i in ('dir /b /a-d "%~dp0*.cmd"') do (
    ...
    if /i "!TargetScript!"=="Morphs_Post_Installs_X-SuperLite.cmd" set "IsExcluded=1"
