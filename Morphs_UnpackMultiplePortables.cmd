...
:: Define static 30-character templates for filled and empty blocks
set "Filled=██████████████████████████████"
set "Empty=░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░"
...
FOR %%f IN (*.exe) DO (
    if exist "%%~f" (
        ...
        :: Generate the bar instantly using string slicing
        set /a "Remaining=30 - Blocks"
        for /f "tokens=1,2" %%a in ("!Blocks! !Remaining!") do (
            set "ActiveBar=!Filled:~0,%%a!!Empty:~0,%%b!"
        )
